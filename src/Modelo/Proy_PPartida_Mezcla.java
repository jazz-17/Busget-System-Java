...
public class Proy_PPartida_Mezcla {
    private int codCia;
    private int codPyto;
    ...
    public Proy_PPartida_Mezcla() {
    }

    public Proy_PPartida_Mezcla(int codCia, int codPyto, String ingEgr, int nroVersion, int codPartida, int corr, int padCodPartida, String tUnitMed, String eUnitMed, int nivel, int orden, float costoUnit, int cant, float costoTot) {
        this.codCia = codCia;
    ...
    public void setDespartida(String dx) {
        this.despartida = dx;
    }
