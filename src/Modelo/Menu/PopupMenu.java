...
public class PopupMenu extends javax.swing.JDialog {
    ...
    public PopupMenu(java.awt.Frame parent, int index, EventMenuSelected eventSelected, String... subMenu) {
        ...
        panel.setLayout(new MigLayout("fill, wrap", "0[fill, 120]0","0[35,fill]0[35,fill]0"));
        int subMenuIndex=-1;
    ...
    private void initComponents() {
        ...
        panel = new Modelo.Menu.PanelShowPopup();
    ...
    private Modelo.Menu.PanelShowPopup panel;
