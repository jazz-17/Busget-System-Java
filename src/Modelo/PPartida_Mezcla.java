...
public class PPartida_Mezcla {
    ...
    public PPartida_Mezcla() {
    }

    public PPartida_Mezcla(int codCia, String ingEgr, int codPartida, int corr, int padCodPartida, String tUnitMed, String eUnitMed, float costoUnit, int nivel, int orden, char vigente) {
        this.codCia = codCia;
        this.ingEgr = ingEgr;
