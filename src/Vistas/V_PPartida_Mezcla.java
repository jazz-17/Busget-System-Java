...
public class V_PPartida_Mezcla extends javax.swing.JPanel {

    public V_PPartida_Mezcla() {
        initComponents();
        setOpaque(false);
    }
    ...
    public void init() {
        ...
        tablaPartida_Mezcla_E.getColumnModel().getColumn(0).setPreferredWidth(25); // Codigoa
        tablaPartida_Mezcla_E.getColumnModel().getColumn(1).setPreferredWidth(120); // Descripción
        tablaPartida_Mezcla_E.getColumnModel().getColumn(2).setPreferredWidth(120); // P. Padre
        tablaPartida_Mezcla_E.getColumnModel().getColumn(3).setPreferredWidth(25); // Corr
        ...
        tablaPartida_Mezcla_E.getColumnModel().getColumn(6).setPreferredWidth(50); // Tab
        tablaPartida_Mezcla_E.getColumnModel().getColumn(7).setPreferredWidth(50); // Elem.
        tablaPartida_Mezcla_E.getColumnModel().getColumn(8).setPreferredWidth(60); // Costo Unit.
        ...
        tablaPartida_Mezcla_I.getColumnModel().getColumn(0).setPreferredWidth(25); // Codigoa
        tablaPartida_Mezcla_I.getColumnModel().getColumn(1).setPreferredWidth(120); // Descripción
        tablaPartida_Mezcla_I.getColumnModel().getColumn(2).setPreferredWidth(120); // P. Padre
        tablaPartida_Mezcla_I.getColumnModel().getColumn(3).setPreferredWidth(25); // Corr
        ...
        tablaPartida_Mezcla_I.getColumnModel().getColumn(6).setPreferredWidth(50); // Tab
        tablaPartida_Mezcla_I.getColumnModel().getColumn(7).setPreferredWidth(50); // Elem.
        tablaPartida_Mezcla_I.getColumnModel().getColumn(8).setPreferredWidth(60); // Costo Unit.
    ...
    private void initComponents() {
        ...
        tablaPartida_Mezcla_I.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Descripción", "P. Padre", "Corr", "Nivel", "Orden", "Tab", "Unidad", "Costo Unit.", "Vigente"
            }
        ) {
        ...
        panelShadow5Layout.setHorizontalGroup(
            ...
            .addGroup(panelShadow5Layout.createSequentialGroup()
                ...
                .addGroup(panelShadow5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(costoUnit_I, javax.swing.GroupLayout.PREFERRED_SIZE, 343, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        panelShadow4Layout.setHorizontalGroup(
            ...
            .addGroup(panelShadow4Layout.createSequentialGroup()
                ...
                .addGroup(panelShadow4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelShadow4Layout.createSequentialGroup()
                        .addComponent(costoUnit_E, javax.swing.GroupLayout.PREFERRED_SIZE, 327, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(panelShadow4Layout.createSequentialGroup()
